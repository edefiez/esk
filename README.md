...
| `esk agent:show <id>` | Show agent details + skills | `esk agent:show jerome` |
...
| `esk agent:add-skill <agent> <skill>` | Assign a skill to an agent | `esk agent:add-skill jerome graphql-api` |
| `esk agent:remove-skill <agent> <skill>` | Remove a skill from an agent | `esk agent:remove-skill jerome graphql-api` |
| `esk agent:publish <id>` | Push to GitHub | `esk agent:publish jerome --json` |
...
| `esk skill:add <agent> <skill>` | Assign skill to agent in the global registry | `esk skill:add jerome graphql-api` |
...
| `esk project:agent:add <id>` | Add an agent to the project | `esk project:agent:add jerome --install-skills` |
| `esk project:agent:remove <id>` | Remove an agent from the project | `esk project:agent:remove jerome` |
| `esk project:agent:add-skill <a> <sk>` | Assign skill → agent (`--install`) | `esk project:agent:add-skill jerome graphql --install` |
| `esk project:agent:status <id>` | Show active skills for an agent | `esk project:agent:status jerome --json` |
| `esk project:skill:install <id>` | Install a skill from the registry | `esk project:skill:install graphql --agent jerome --yes` |
...
esk project:skill:create --id "stripe-webhooks" --category backend \
  --description "Stripe webhook handling" --agent jerome --yes --json
```
